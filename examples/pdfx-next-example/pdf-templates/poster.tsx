        ...
        <Page size="Tabloid" orientation="landscape" margin="0">
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-center">
              {/* Headline - using custom display font from globals.css */}
            ...
            <div className="flex items-end justify-between">
              ...
              <div className="flex gap-4">
                {data.highlights.map((highlight, i) => (
                  <div
                    key={i}
                    className="border-2 border-gray-600 text-white px-6 py-3 rounded-full text-base font-semibold hover:border-cyan-500 transition-colors"
                  >
                    {highlight}
                  </div>
                ))}
