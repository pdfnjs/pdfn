---
title: Quickstart
description: Install pdfn in a Next.js project, create a template, add an API route, and generate your first PDF. No API key required for local development.
