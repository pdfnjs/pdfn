---
title: Next.js
description: Generate PDFs in Next.js with App Router and Pages Router. Includes API route examples, download buttons, streaming, and edge runtime considerations.
