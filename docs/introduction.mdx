---
title: Introduction
description: Build PDF templates with React components. pdfn handles pagination, headers, footers, and rendering — with consistent output across local dev and production.
