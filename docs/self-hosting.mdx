---
title: Self-Hosting
description: Run PDF generation on your own infrastructure using Puppeteer or Playwright. Use client.render() to get HTML, then convert to PDF with your own browser.
