---
title: Styling
description: Style PDF templates with Tailwind CSS, custom stylesheets, or inline styles. Includes the Tailwind component, CSS-in-JS support, and print CSS notes.
keywords: ["PDF styling", "Tailwind CSS", "custom CSS", "inline styles", "PDF design"]
---
